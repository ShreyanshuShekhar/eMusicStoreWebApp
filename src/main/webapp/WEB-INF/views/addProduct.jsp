...
<div class="container-wrapper" style="padding-top: 100px">
    <div class="container">
        <div class="page-header">
            <h1>Add Products</h1>
            <p class="lead">Fill in the below information for adding a product:</p>
        </div>
        ...
        <div class="form-group">
            <label class="custom-control-label" for="productImage">Upload Image</label>
        ...
        <a href="<c:url value="/admin/productInventory"/>" class="btn btn-outline-danger">Cancel</a>
        </form:form>
